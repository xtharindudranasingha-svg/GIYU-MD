...
<span style="font-size: 40px;"><b>[@TegarPriyadi](https://github.com/TegarPriyadi)</b></span>
...
```javascript
import getFBInfo from "fb-downloader-new";
